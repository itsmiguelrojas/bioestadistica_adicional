...
print(data.frame(individuo = 1:20, altura = salida.campo.muestra))
```
...
```{r}
salida.campo.diff <- salida.campo.muestra-6
salida.campo.diff
```
...
```{r}
c(1,2.5,2.5,5.5,5.5,5.5,5.5,8,10.5,10.5,10.5,10.5,13,14,15,16.5,16.5,18,19)
```
...
```{r}
salida.campo.ranking <- c(1,-2.5,2.5,-5.5,-5.5,-5.5,5.5,8,-10.5,-10.5,-10.5,10.5,-13,-14,15,16.5,16.5,18,19)
