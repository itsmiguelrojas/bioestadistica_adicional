...
.pull-left[
Ya vimos que la varianza de uno de los grupos es menor, y además ese mismo grupo posee una distribución no normal. No obstante, podemos realizar un análisis de varianza (ANOVA)
]
